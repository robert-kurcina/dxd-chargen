...
function SpeciesStep({ data, draft, setDraft }: Omit<IntrinsicsStepProps, 'stepValue'>) {
  ...
  const exampleGroups = [...new Set(
    draft.intrinsics.childOfStrife && parents
      ? [parents.fatherGroup, parents.motherGroup]
