            ...
            <div className="overflow-x-auto rounded-lg border">
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  <tr className="border-t"><td className="px-3 py-2">FOR DM → Build</td><td className="px-3 py-2 text-right">—</td><td className="px-3 py-2 text-right tabular-nums">{signed(physical.fortDm)}</td><td className="px-3 py-2 text-right">—</td></tr>
                  <tr className="border-t"><td className="px-3 py-2">Brawn {physical.brawn} → Build</td><td className="px-3 py-2 text-right">—</td><td className="px-3 py-2 text-right tabular-nums">{signed(physical.brawn)}</td><td className="px-3 py-2 text-right">—</td></tr>
