            ...
            <div className="overflow-x-auto rounded-lg border">
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  <tr className="border-t"><td className="px-3 py-2">FOR DM + Brawn → Build</td><td className="px-3 py-2 text-right">—</td><td className="px-3 py-2 text-right">included</td><td className="px-3 py-2 text-right">—</td></tr>
