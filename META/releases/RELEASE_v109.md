...
- `META/guidance/` owns all `CANON_SYNC_v*.md` files plus the application `blueprint.md` and `FINAL_PRODUCT_PLAN.md`.
- `META/releases/` owns release notes, data-integrity material, and machine-readable validation reports.
